...
The point calculated using the Ramsey Rule is located at `x = 0.021`, and `y = 70.65`.
...
difference_ab <- policy_a_pv-policy_b_pv

```

Expected damages under Policy A: `r policy_a_pv`
Expected damages under Policy B: `r policy_b_pv`
Initial undertaking of Policy B would have to cost less than `r difference_ab` to justify choosing Policy A over Policy B
